...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView logo,
      @NonNull ConstraintLayout main, @NonNull Button signInBtn, @NonNull Button signUpBtn,
      @NonNull Button testBtn, @NonNull TextView textView4) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, logo, main, signInBtn, signUpBtn,
          testBtn, textView4);
    }
